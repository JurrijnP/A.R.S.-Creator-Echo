...
$prefEmp = $emailErr = $genderErr = $websiteErr = "";
$pref = $email = $gender = $comment = $website = "";
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  Your Prefix: <input type="text" name="pref" value="<?php echo $pref;?>">
  <span class="error">* <?php echo $prefEmp;?></span>
  <br><br>
